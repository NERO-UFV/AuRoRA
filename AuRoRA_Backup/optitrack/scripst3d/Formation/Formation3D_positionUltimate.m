...
LF.pPar.K1 = 1*diag([0.4 0.4 0.5 1.5 0.75 0.6]);    % kinematic control gain  - controls amplitude
...
Qd = [  1.5  0      0   1.5     0     pi/2;
        0    1      0   1       0     pi/2; 
       -1.1  0.5    0   0.6     0     pi/2;
       -1.1  -1     0   1       0     pi/2;
        0    -1     0   1       0     pi/2;
        1   -0.5    0   1       0     pi/2; 
       -0.5  0      0   1.5     0     pi/2];
