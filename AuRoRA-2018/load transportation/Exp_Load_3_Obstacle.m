...
ForceFieldPar.Forc = [0.00 0.01];
ForceFieldPar.Dist = [0.8 1.0];

gains = [1.2 2.6 1.2 2.6 5 15;
         2 15 2 15 1 10];
...
O(1).pPos.X(1:3) = [ 0 0 2000]/1000;
O(2).pPos.X(1:3) = [ -500 -1000 2000]/1000;
O(3).pPos.X(1:3) = [ -500 +1000 2000]/1000;
%% Open file to save data
% DroneVar = CreateDataFile(A,'Sim','Log_Optitrack');
OptData = CreateOptDataFile(A,L,'Tape1','Log_LoadTransportation');
