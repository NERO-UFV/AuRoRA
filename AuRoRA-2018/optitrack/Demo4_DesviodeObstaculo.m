...
%         A.rGetAngles;
        ...
        Distancia(1:3) =  [Obst.pPos.X(1)-A.pPos.X(1)-Raiodoobstaculo... % Distância em X
            Obst.pPos.X(2)-A.pPos.X(2)-Raiodoobstaculo... % Distância em Y
            pdist([Obst.pPos.X(1:2);A.pPos.X(1:2)'])-Raiodoobstaculo]; %Módulo da Distância
