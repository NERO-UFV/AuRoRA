...
% Marcadores de tempo
T_MAX = 5;                 % Tempo maximo de duração de cada tarefa
...
%                 TF{2}.pPos.Qd(2) = abs(Yfi(2));
        ...
        case 6
            if toc(T) > T_MAX/2
                ...
                A{2}.pPos.X(1:3) = TF{2}.pPos.X(4:6);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    switch etapa
        ...
        case 6
            % FORMAÇÃO 2
            TF{2}.pPos.Qd = QdA{2}+Qdtil{2}*toc(T)/(T_MAX/2);
        case 7
            % FORMAÇÃO 2
            TF{2}.pPos.Qd = QdA{2};
            % FORMAÇÃO 3
        ...
        case 8
            % FORMAÇÃO 2
            TF{2}.pPos.Qd = QdA{2}+Qdtil{2}*toc(T)/(T_MAX/4);
            % FORMAÇÃO 3
            TF{3}.pPos.Qd = QdA{3};
        case 9
            % FORMAÇÃO 2
