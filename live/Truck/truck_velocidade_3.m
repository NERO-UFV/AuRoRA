...
figure
plot(Dados(end,:),Dados(27,:),'Color','k','LineWidth',1.6,'AlignVertexCenters','on')
hold on
grid on
plot(Dados(end,:),Dados(29,:),'LineStyle','--','Color','k','LineWidth',1.6,'AlignVertexCenters','on')
legend('Velocidade Limitada','Velocidade Desejada');
xlabel('$\textbf{Tempo [s]}$','interpreter','latex','FontWeight','bold');
ylabel('$\textbf{Velocidade Linear [m/s]}$','interpreter','latex','FontWeight','bold');

figure
plot(Dados(end,:),Dados(28,:),'Color','k','LineWidth',1.6,'AlignVertexCenters','on')
hold on
grid on
plot(Dados(end,:),Dados(30,:),'LineStyle','--','Color','k','LineWidth',1.6,'AlignVertexCenters','on')
legend('Velocidade Limitada','Velocidade Desejada');
xlabel('$\textbf{Tempo [s]}$','interpreter','latex','FontWeight','bold');
ylabel('$\textbf{Velocidade Angular [rad/s]}$','interpreter','latex','FontWeight','bold');