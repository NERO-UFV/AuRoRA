...
% % % LF{2}.pPar.K1 = diag([  1.0   1.0   1.0   1.0    0.50   0.50  ]);     % kinematic control gain  - controls amplitude
% % % LF{2}.pPar.K2 = diag([  0.5   0.5   0.5   0.5    0.05   0.05  ]);     % kinematic control gain - control saturation
% % % 
% % % for ii = [1 3]
% % %     LF{ii}.pPar.K1 = diag([  1.0   1.0   1.0   1.0    2.0   2.0  ]);     % kinematic control gain  - controls amplitude
% % %     LF{ii}.pPar.K2 = diag([  0.5   0.5   0.5   0.5    0.1   0.1  ]);     % kinematic control gain - control saturation
% % % end

LF{2}.pPar.K1 = diag([  1.0   1.0   1.0   1.0    2.0   2.0  ]);     % kinematic control gain  - controls amplitude
LF{2}.pPar.K2 = diag([  0.5   0.5   0.5   0.5    0.3   0.3    ]);     % kinematic control gain - control saturation

for ii = [1 3]
    LF{ii}.pPar.K1 = diag([  1.0   1.0   1.0   1.0    2.0   2.0  ]);     % kinematic control gain  - controls amplitude
    LF{ii}.pPar.K2 = diag([  0.5   0.5   0.5   0.5    0.3   0.3  ]);     % kinematic control gain - control saturation
end
...
P{2}.rSetPose([ 1.0 0.0 0.01 pi/4]');
P{2}.pSC.Ud = [0 ; 0];
...
% P2
P{2}.pPos.Xd(1:3) = Xd(1:3) + [ 1.0 ; 0.0 ; 0.01 ]; % Posição desejada
