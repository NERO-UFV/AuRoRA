...
while toc(t)< T
    ...
    if toc(t_Formation) > T_FORMATION
        ...
        LF.pPos.Qd(5) = pi/18;                          % alpha (frente/trás)
        ...
        % Formation Control
        LF.pPar.K1 = diag([   10.0   10.0   10.0   0.1  0.5  0.5]);     % kinematic control gain  - controls amplitude
    ...
    if toc(t_plot) > T_PLOT
        ...
        % Percourse made
        fig1 = plot3(data(2:kk,1),data(2:kk,2),data(2:kk,3),'r-','LineWidth',1.0);
        fig2 = plot3(data(2:kk,13),data(2:kk,14),data(2:kk,15),'r--','LineWidth',0.5);
        fig3 = plot3(data(2:kk,25),data(2:kk,26),data(2:kk,27),'b-','LineWidth',1);
        fig4 = plot3(data(2:kk,37),data(2:kk,38),data(2:kk,39),'b--','LineWidth',0.5);
        fig5 = plot3(data(2:kk,49),data(2:kk,50),data(2:kk,51),'k--','LineWidth',0.5);
