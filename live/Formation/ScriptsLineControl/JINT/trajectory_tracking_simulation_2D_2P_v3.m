...
while toc(t)< T4
    ...
    if toc(t_Formation) > T_FORMATION
        ...
        LF{3}.pPos.Qd = Xd + [ 1.0 ; 0.0 ; 0.0 ;   1.01  ;  0.0  ; 0.0  ];
        LF{4}.pPos.Qd = Xd + [ 0.0 ; 0.0 ; 1.0 ;   1.01  ;  pi/2 ; 0.0  ];
        ...
        % A1
        A{1}.pPos.Xda = A{1}.pPos.Xd;   % save previous posture
        A{1}.pPos.Xd(1:3) = LF{4}.pPos.Xr(1:3); % Posição desejada
        A{1}.pPos.Xd(7:9) = LF{4}.pPos.dXr(1:3);
        
        % P2
        P{2}.pPos.Xd(1:3) = LF{3}.pPos.Xr(1:3); % Posição desejada
        P{2}.pPos.Xd(7:9) = LF{3}.pPos.dXr(1:3);        % Velocidade desejada
