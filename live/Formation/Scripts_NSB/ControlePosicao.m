...
zp = 0;
t = tic;
tt_T = text(xp,yp+yinc*2,['t = ',num2str(toc(t),'%3.1f'),' [s]','         IAE = ',num2str(IAE,'%3.1f')],'FontWeight','bold');
tt_V = text(xp,yp+yinc,['v = ',num2str(P.pSC.U(1),'%3.1f'), ' [m/s]','    ITAE = ',num2str(ITAE,'%3.1f')],'FontWeight','bold');
tt_W = text(xp,yp,['w = ',num2str(180/pi*P.pSC.U(2),'%2.1f'), ' [°/s]','     IASC = ',num2str(IASC,'%3.1f')],'FontWeight','bold');
drawnow;
...
while toc(t) < tmax+0.2
    ...
    if toc(ta) > .1
        ...
        tt_T.String = ['t = ',num2str(toc(t),'%3.1f'),' [s]','        IAE = ',num2str(IAE,'%3.1f')];
        tt_V.String = ['v = ',num2str(P.pSC.U(1),'%3.1f'), ' [m/s]','     ITAE = ',num2str(ITAE,'%3.1f')];
        tt_W.String = ['w = ',num2str(180/pi*P.pSC.U(2),'%2.1f'), ' [°/s]','      IASC = ',num2str(IASC,'%3.1f')];
