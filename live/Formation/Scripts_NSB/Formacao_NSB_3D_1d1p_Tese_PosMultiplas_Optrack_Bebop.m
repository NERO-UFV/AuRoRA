...
% Ajusted Gains
NSBF.pPar.K1 =     2*diag([1 1 1 1 0.5 0.5]);              % kinematic control gain - controls saturation 
NSBF.pPar.K2 =       diag([1 1 1 1 1 1]);                  % kinematic control gain - control amplitude
...
%         Rede.mSendMsg(P);    
        ...
        comandosP = [comandosP; P.pSC.Ud(1) P.pSC.Ud(2)];
