...
Ts = F{1}.pPar.Ts;
F{1}.mTrajectoryPlanner_TF3D_mexido(0);
...
while toc(t)< Tf
    ...
    if toc(t_ArDrone_1) > T_ARDRONE
        t_ArDrone_1 = tic;
        A{1}.pPos.X(1:3) = F{1}.pPos.Xr(1:3) + 0*(real(rand()- rand()));
