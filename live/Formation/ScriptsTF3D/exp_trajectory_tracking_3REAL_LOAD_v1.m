...
%% Plot
% try
%     NO_LOAD = zeros(800,142);
%     NO_LOAD(1:500,:) = data;
%     for i = 500:800
%         NO_LOAD(i,:) = data(1000-i,:);
%     end
% catch
% end
% 
...
figure()
subplot(311)
plot(data(1:last,154),0.5*NO_LOAD(1:last,106),'LineWidth',1.5);
hold on;
...
subplot(312)
plot(data(1:last,154),0.5*NO_LOAD(1:last,107),'LineWidth',1.5);
hold on;
...
subplot(313)
plot(data(1:last,154),0.5*NO_LOAD(1:last,108),'LineWidth',1.5);
hold on;
...
figure()
subplot(311)
plot(data(1:last,154),0.5*NO_LOAD(1:last,109),'LineWidth',1.5);
hold on
...
subplot(312)
plot(data(1:last,154),0.5*NO_LOAD(1:last,110),'LineWidth',1.5);
hold on
...
figure()
subplot(311)
plot(data(1:last,154),0.5*180/pi*NO_LOAD_O(1:last,112),'LineWidth',1.5);
hold on
...
subplot(312)
plot(data(1:last,154),0.5*180/pi*NO_LOAD_O(1:last,113),'LineWidth',1.5);
hold on
...
subplot(313)
plot(data(1:last,154),0.5*180/pi*NO_LOAD_O(1:last,114),'LineWidth',1.5);
hold on
