...
%         
        ...
        P{1}.pPos.Xd(1:2) = TF{1}.pPos.Xr(1:2);             % Posição desejada
        P{1}.pPos.Xd(7:8) = TF{1}.pPos.dXr(1:2);            % Velocidade desejada
        
        P{2}.pPos.Xd(1:2) = TF{1}.pPos.Xr(4:5);             % Posição desejada
        P{2}.pPos.Xd(7:8) = TF{1}.pPos.dXr(4:5);            % Velocidade desejada
        
        P{3}.pPos.Xd(1:2) = TF{1}.pPos.Xr(7:8);             % Posição desejada
        P{3}.pPos.Xd(7:8) = TF{1}.pPos.dXr(7:8);            % Velocidade desejada
        
        P{4}.pPos.Xd(1:2) = TF{2}.pPos.Xr(7:8);             % Posição desejada
