...
fileName = strcat('Validacao_Parametros_PSI_1','.mat');
fullFileName = strcat(dataPath,fileName);
save(fullFileName,'tempo','velocidades','v');

%%
figure
hold on
plot(tempo,velocidades(:,1),'b')
plot(tempo,v(1:length(tempo),1),'r')
title('Velocidade X')
xlabel('Tempo(s)');
...
figure
hold on
plot(tempo,velocidades(:,2),'b')
plot(tempo,v(1:length(tempo),2),'r')
title('Velocidade Y')
xlabel('Tempo(s)');
ylabel('Velocidade (m/s)');
legend('Experimento','Simulação');
...
figure
hold on
plot(tempo,velocidades(:,3),'b')
plot(tempo,v(1:length(tempo),3),'r')
title('Velocidade Z')
xlabel('Tempo(s)');
ylabel('Velocidade (m/s)');
legend('Experimento','Simulação');
