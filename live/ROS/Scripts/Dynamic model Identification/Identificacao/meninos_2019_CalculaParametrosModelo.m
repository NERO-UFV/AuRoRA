...
clc, clear, close all;
load TOPZERADASGALAXIAS_Calibracao_UFV_Y_Ka=0.5_Kw=0.62832_Serial_71.mat;
%%
...
plot(Theta1.T(2,:)), 
legend(['\theta1 = '  num2str(Theta1.T(1,end))], ['\theta1 2 = '  num2str(Theta1.T(2,end))]);
title('Variando X')
axis tight
%
figure,
...
plot(Theta2.T(2,:)), 
legend(['\theta2 = '  num2str(Theta2.T(1,end))], ['\theta2 2= '  num2str(Theta2.T(2,end))]);
title('Variando Y')
axis tight
%
figure,
...
plot(Theta3.T(2,:)), 
legend(['\theta3 = '  num2str(Theta3.T(1,end))], ['\theta3 2= '  num2str(Theta3.T(2,end))]);
title('Variando Z')
axis tight
%
figure,
...
plot(Theta4.T(2,:)), 
legend(['\theta4 = '  num2str(Theta4.T(1,end))], ['\theta4 2= '  num2str(Theta4.T(2,end))]);
title('Variando \psi')
axis tight