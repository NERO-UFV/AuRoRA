function s_desvio = gera_abcissa_curvilinea_desvio_longo(pontoInicial,pontoFinal,obs_ativo,inc_desvio)
...
% Cuida da descontinuidade em [0,360]
if inc_desvio > 0 && ang_obs_inicio_positivo > ang_obs_final_positivo
    ang_obs_inicio_positivo = ang_obs_inicio;
end
...
%Cuida dos casos onde a rotação leva a mudança de mais de dois quadrantes
if inc_desvio > 0 && ang_obs_inicio_positivo > ang_obs_final_positivo
    ang_obs_final_positivo = ang_obs_final_positivo + 360;
end

if inc_desvio < 0 && ang_obs_inicio_positivo < ang_obs_final_positivo
    ang_obs_inicio_positivo = ang_obs_inicio_positivo - 360;
end

% Define a abcissa curvilínea do desvio
% s_desvio = ang_obs_inicio:inc_desvio:ang_obs_final;
s_desvio = ang_obs_inicio_positivo:inc_desvio:ang_obs_final_positivo;