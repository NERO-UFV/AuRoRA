       ...
       U_robo_real([1 2 3]) = [v0_c 0 w0_c];   %%%% sinal de controle cinematico para o robo1
        ...
        velocidades_robo = K_roboz*([P.pPos.Xc(7);P.pPos.Xc(8);P.pPos.Xc(12)]);
         ...
         %%%% -------------   compensador dinâmico real ---------------
          ...
          G_real = [0 0 -velocidades_robo(3)^2 velocidade_real_robo 0 0; ...
               0 0 0 0 P.pPos.Xc(12)*velocidade_real_robo P.pPos.Xc(12)];
          
          delta_1_real = U1_robo_real_ref + k_u*(U_robo_real(1) - velocidade_real_robo);
...
%       end
      ...
      velocidade_real_trailer2 = -sqrt(velocidades_trailer2(1)^2+velocidades_trailer2(2)^2);
      
      %%%%%%%%%%% ---------------------Calculo erro velocidade ---------------------
      erro_v_linear = abs(-Vd - velocidade_real_trailer2);
      erro_v_angular = abs(v_fi_real - P3.pPos.Xc(12));
      ...
      %%%%% ------------------------------------------------
        ...
        V_real_trailer2_hist = [V_real_trailer2_hist velocidade_real_trailer2];
