...
% xd = [cos(omega*toc(t)) sin(omega*toc(t)) 1 0]';
% xdold = xd;
% xd = [cos(omega*toc(t)) sin(omega*toc(t)) 1 0]';
% % xdp = (xd-xdold)/To;
% xdpold = xdp;
...
% % %             %Circulo
% % %             xd = [cos(omega*toc(t)) sin(omega*toc(t)) 1.75 0]';
% % %             xdp = [-omega*sin(omega*toc(t)) omega*cos(omega*toc(t)) 0 0]';
% % %             xd2p = [-omega^2*cos(omega*toc(t)) -omega^2*sin(omega*toc(t)) 0 0]';
