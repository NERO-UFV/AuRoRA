...
% XX = load('Traj_20180925T160337.txt')';   
XX = load('Traj_20180925T160124.txt')';    
% XX = load('teste_drone_20180724T145702.txt')';
% XX = load('best_drone_20180724T154608.txt')';
