...
%% Carrega dados
data = load('FL3d_PositionUtimateNewControllers20200113T142414.txt');
...
sizeLegend  = 17;     % tamanho das legendas
...
leg1 = legend([pstart1 pend1 pdes1 pdes2 preal1 preal2],{'Initial position', ...
    'Final position','Desired position for the UGV', ...
    'Desired position for the UAV', ...
    'Path followed by the UGV','Path followed by the UAV'});
...
% xlabel('Tempo [s]','FontSize',sizeLabel,'interpreter','Latex'); PT
% ylabel('Erro [m]','FontSize',sizeLabel,'interpreter','Latex');
xlabel('Time [s]','FontSize',sizeLabel,'interpreter','Latex'); % EN
