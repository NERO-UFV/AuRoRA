...
%% Carrega dados
% data = load('FL3d_TrajectoryUtimateExpNewControllers20200110T114944.txt');
data = load('FL3d_PositionUtimateBebop20200113T203905.txt');
% data = load('FL3d_TrajectoryUtimateExpNewControllers20200111T184623.txt');
% data = load('FL3d_TrajExp20181002T195507.txt');
...
leg1 = legend([pstart1 pend1 pdd1 preal1 preal2],{'Start position','Final Position','Desired Trajectory','Pioneer3-DX','ArDrone 2.0'});
% lg1 = legend([ps1 pd1],{'Start position','Desired Positions'});
% lg1 = legend(pl,{'Formation line'});
%
leg1.FontSize = sizeLegenda;
