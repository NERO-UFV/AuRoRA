function [] = rPlotPerformanceAnalysisVar(tmax)
...
%     filename = sprintf('C:%cUsers%cleo_j%cDropbox%cDropbox%cAuRoRA 2018%cTime-delayed Communication%cDados Simu%cPosition%csimu_atraso_variavel%d.mat', '\', '\', '\', '\', '\', '\', '\', '\', '\',j);
    if j == 1
        ...
        name_fig = sprintf('C:%cUsers%cleo_j%cDropbox%cDropbox%cAuRoRA 2018%cTime-delayed Communication%cFigs%cfigTaj Atraso_Variável(Circunferência)', '\', '\', '\', '\', '\', '\', '\', '\');

    else
        name_fig = sprintf('C:%cUsers%cleo_j%cDropbox%cDropbox%cAuRoRA 2018%cTime-delayed Communication%cFigs%cfigTraj Atraso_Variável(Lemniscata)', '\', '\', '\', '\', '\', '\', '\', '\');
    ...
    ylabel('IAE','FontSize',13,'FontWeight','bold','interpreter','Latex')
    ...
    ylabel('ITAE','FontSize',13,'FontWeight','bold','interpreter','Latex')
    ...
    ylabel('IASC','FontSize',13,'FontWeight','bold','interpreter','Latex')


%     name_fig = sprintf('C:%cUsers%cleo_j%cDropbox%cDropbox%cAuRoRA 2018%cTime-delayed Communication%cFigs%cfigPos Atraso_Variável%d (Indices_Desempenho)', '\', '\', '\', '\', '\', '\', '\', '\', j);
