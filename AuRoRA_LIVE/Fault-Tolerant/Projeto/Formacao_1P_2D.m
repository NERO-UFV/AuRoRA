...
%                  lê X e acha Q
            ...
            case 5 % Drone 1 segue voando, agora em cima do pioneer
                A{1}.pPos.Xd([1:3 6]) = [raio*cos(psi)*cos(Ang + (pi/2 - Ang)*toc(t)/T_E(5));
                                         raio*sin(psi)*cos(Ang + (pi/2 - Ang)*toc(t)/T_E(5));
                                         raio*sin(Ang + (pi/2 - Ang)*toc(t)/T_E(5));
                                         0];
                A{1}.pPos.Xd([7:9 12]) = [-((pi/2 - Ang)/T_E(5))*raio*cos(psi)*sin(Ang + (pi/2 - Ang)*toc(t)/T_E(5));
                                          -((pi/2 - Ang)/T_E(5))*raio*sin(psi)*sin(Ang + (pi/2 - Ang)*toc(t)/T_E(5));
...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -% 
        ...
        switch Etapa
            case 1
                A{2} = cInverseDynamicController_Compensador_ArDrone2(A{2});
            case 2
                A{1} = cInverseDynamicController_Compensador_ArDrone2(A{1});%% Send control signals
                A{2} = cInverseDynamicController_Compensador_ArDrone2(A{2});
            case 3
                A{1} = cInverseDynamicController_Compensador_ArDrone2(A{1});%% Send control signals
                A{2} = cInverseDynamicController_Compensador_ArDrone2(A{2});
