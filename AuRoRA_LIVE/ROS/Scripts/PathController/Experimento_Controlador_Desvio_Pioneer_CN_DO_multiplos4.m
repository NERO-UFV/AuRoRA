...
P5 = getOptData(rb(idT4),P5);   % get pioneer data
...
try
    ...
    while t_max > toc(t)
        if toc(t_c) > T_c
            ...
            Obstaculos = [P2.pPos.Xc(1:3) P3.pPos.Xc(1:3) P4.pPos.Xc(1:3) P5.pPos.Xc(1:3)];
...
%   writerObj = VideoWriter('Desvio_Caminho_4obstaculos_lemniscata.mp4','MPEG-4');
