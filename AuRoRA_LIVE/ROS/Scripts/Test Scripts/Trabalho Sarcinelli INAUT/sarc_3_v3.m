...
% Plotagem em tempo real FUNCIONANDO
% T = 0.0015;
% T_plot = 29.5;
% tmax = 30;

% Plotagem somente ao final
% T = 0.02;
% T_plot = 119.5;
% tmax = 120;
...
% UAV 1
dX_max = 1*diag([1.60 1.10 0.25 0.25]);

% UAV 2
% dX_max = diag([3.20 2.20 1.00 1.00]);
