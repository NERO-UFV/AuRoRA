...
if drone.pCAD.flagLines == 1  % Create the demo line
    drone.pCAD.i2D.Vertices = [drone.pPos.Q(6) drone.pPos.Q(6) drone.pPos.Q(6)+0.0001;...
    drone.pPos.Q(7) drone.pPos.Q(7) drone.pPos.Q(7);...
    0 drone.pPos.Q(8) drone.pPos.Q(8)]';
end
...
if drone.pCAD.flagCreated == 0
    ...
    % Update drone pose
    %%% Rotational matrix
    RotX = [1 0 0; 0 cos(drone.pPos.Q(3)) -sin(drone.pPos.Q(3)); 0 sin(drone.pPos.Q(3)) cos(drone.pPos.Q(3))];
    RotY = [cos(drone.pPos.Q(4)) 0 sin(drone.pPos.Q(4)); 0 1 0; -sin(drone.pPos.Q(4)) 0 cos(drone.pPos.Q(4))];
    RotZ = [cos(drone.pPos.Q(5)) -sin(drone.pPos.Q(5)) 0; sin(drone.pPos.Q(5)) cos(drone.pPos.Q(5)) 0; 0 0 1];
    
    Rot = RotZ*RotY*RotX;
    H = [Rot drone.pPos.Q(6:8); 0 0 0 1];
