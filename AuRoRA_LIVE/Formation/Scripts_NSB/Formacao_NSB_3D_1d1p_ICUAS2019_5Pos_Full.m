...
NSBF2.pPos.X  = [4;-2;0;-4;-2;1];    % real pose [x1 y1 z1 x2 y2 z2]
NSBF3.pPos.X  = [4;-2;0;-4;-2;1];    % real pose [x1 y1 z1 x2 y2 z2]

% Inicialize Simulation Positions
...
plot3(A2.pPos.X(1),A2.pPos.X(2),A2.pPos.X(3),'b^','LineWidth',0.8);

% plot robots initial positions
plot3(P3.pPos.X(1),P3.pPos.X(2),P3.pPos.X(3),'r^','LineWidth',0.8); hold on;
plot3(A3.pPos.X(1),A3.pPos.X(2),A3.pPos.X(3),'b^','LineWidth',0.8);
...
for kk = 1:size(Qd,1)
    ...
    plot3(NSBF2.pPos.Xd(4),NSBF2.pPos.Xd(5),NSBF2.pPos.Xd(6),'b.','MarkerSize',20,'LineWidth',2);        
    plot3(NSBF3.pPos.Xd(4),NSBF3.pPos.Xd(5),NSBF3.pPos.Xd(6),'b.','MarkerSize',20,'LineWidth',2);
...
%         || abs(NSB.pPos.Qtil(6))>erroMax(6) % formation errors
    ...
    %if toc(tp) > 0.5
        ...
        P2.mCADdel                      % Pioneer
        P2.mCADplot(1,'k');             % Pioneer modelo bonitão
        A2.mCADplot;                    % ArDrone

        P3.mCADdel                      % Pioneer
        P3.mCADplot(1,'k');             % Pioneer modelo bonitão
        A3.mCADplot;                    % ArDrone
        ...
        fig3 = plot3(data2(:,13),data2(:,14),data2(:,15),'g-','LineWidth',0.8); hold on;
        fig4 = plot3(data2(:,41),data2(:,42),data2(:,43),'k-','LineWidth',0.8);

        fig5 = plot3(data3(:,13),data3(:,14),data3(:,15),'m-','LineWidth',0.8); hold on;
        fig6 = plot3(data3(:,41),data3(:,42),data3(:,43),'c-','LineWidth',0.8);
