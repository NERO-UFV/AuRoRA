...
P{2}.rSetPose([ 1.0 0.0 0.001 pi/4]');
P{2}.pSC.Ud = [0 ; 0];
...
A{1}.pPos.Xd(1:3) = Xd(1:3) + [ 0.0 ; 0.0 ; 1.001 ]; % Posição desejada
A{1}.pPos.Xd(7:9) = dXd(1:3);

% P2
P{2}.pPos.Xd(1:3) = Xd(1:3) + [ 1.0 ; 0.0 ; 0.001 ]; % Posição desejada
...
T_PLOT = 2; %149;       % Período de plotagem em tempo real
