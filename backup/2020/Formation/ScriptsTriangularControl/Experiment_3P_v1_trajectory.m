...
% Ganhos           
TF{1}.pPar.K1 = 1*diag([    5.0    5.0    5.0    5.0   5.0   5.0   ]);     % kinematic control gain  - controls amplitude
...
% idP{4} = getID(OPT,P{4})+3;          % pioneer ID on optitrack
...
% P{4} = getOptData(rb(idP{4}),P{4});   % get pioneer data
...
%         cgains = [ 0.35  0.35  0.80  0.80  0.75  0.75  0.12  0.035 ];
        cgains = [ 0.10  0.10  0.75  0.75  0.75  0.75  0.10  0.01 ];
