...
LF{ii}.pPar.K1 = diag([  1.0   1.0   1.0   1.0    0.50   0.50  ]);     % kinematic control gain  - controls amplitude
LF{ii}.pPar.K2 = diag([  0.5   0.5   0.5   0.5    0.05   0.05  ]);     % kinematic control gain - control saturation
