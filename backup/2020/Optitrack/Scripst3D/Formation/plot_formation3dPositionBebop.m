...
data = load('FL3d_PositionUtimateBebop20200113T201735.txt');
...
lg1 = legend([ps1 pd1 pd2],{'Posi\c{c}\~{a}o inicial','Posi\c{c}\~{a}o desejada Pioneer 3-DX','Posi\c{c}\~{a}o desejada AR.Drone2.0'});
...
leg1 = legend([pstart1 pend1 pdes1 pdes2 preal1 preal2],{'Posi\c{c}\~{a}o inicial', ...
    ...
    'Posi\c{c}\~{a}o desejada Bebop', ...
    'Posi\c{c}\~{a}o real Pioneer 3-DX','Posi\c{c}\~{a}o real Bebop'});
