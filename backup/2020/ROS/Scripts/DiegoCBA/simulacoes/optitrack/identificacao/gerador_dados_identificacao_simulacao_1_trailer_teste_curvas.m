...
%         u_ref = 0.15*(-0.1*sin(ww*t_atual) + 0.5*sin(2*ww*t_atual) - 0.4*sin(5*ww*t_atual) + 4*sin(0.2*ww*t_atual) + 2*sin(0.5*ww*t_atual));
%         w_ref = 0.5*(cos(ww*t_atual) - 1.5*cos(2*ww*t_atual) - 2*sin(0.8*ww*t_atual) + 0.15*sin(0.2*ww*t_atual) + 0.85*sin(10*ww*t_atual));
        
%         u_ref = 0.2*(0.1*sin(ww*t_atual) + 0.5*sin(2*ww*t_atual) - 0.4*sin(5*ww*t_atual) + 4*sin(0.2*ww*t_atual) + 2*sin(0.5*ww*t_atual));
%         w_ref = 0.5*(cos(ww*t_atual) - 1.5*cos(2*ww*t_atual) - 2*sin(0.8*ww*t_atual) + 0.15*sin(0.2*ww*t_atual)- 0.55*sin(10*ww*t_atual));
        
        u_ref = 0.1*(0.1*sin(ww*t_atual) + 0.5*sin(2*ww*t_atual) + 0.4*sin(5*ww*t_atual) + 4*sin(0.2*ww*t_atual) + 2*sin(0.5*ww*t_atual));
        w_ref = 0.2*(sin(ww*t_atual) - 1.5*sin(2*ww*t_atual) - 2*sin(0.8*ww*t_atual) + 0.15*sin(0.2*ww*t_atual)- 0.55*sin(10*ww*t_atual));
%       
