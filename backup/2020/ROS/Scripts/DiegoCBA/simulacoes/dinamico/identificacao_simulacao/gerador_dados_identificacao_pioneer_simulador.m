...
%%
path = ['C:\Users\lai1u\Dropbox\AuRoRA 2018\ROS\Scripts\DiegoCBA\simulacoes\dinamico\identificacao_simulacao\'];
filename = ['Diego_identificacao_simulacao1' num2str(T) '_Data_' datestr(now,30) '.mat'];
