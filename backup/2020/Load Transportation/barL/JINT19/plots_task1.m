...
vel = (data(2:5:end,1:12) - data(1:5:end-1,1:12))./(data(2:5:end,end) - data(1:5:end-1,end));

%acc
% acc = (vel(2:end,1:12) - vel(1:end-1,1:12))./0.0334;
% acc = (vel(2:5:end,1:12) - vel(1:5:end-1,1:12))./(data(3:5:end,end) - data(2:5:end-1,end));

% vel load
vel_load = (data(2:5:end,13:15) - data(1:5:end-1,13:15))./(data(2:5:end,end) - data(1:5:end-1,end));
...
% plot3(data(:,7), data(:,8), data(:,9),'k--');
plot3(data(:,13)-.05, data(:,14)-.08, data(:,15)-.12,'g-');
plot3(data(:,35), data(:,36),data(:,37),'k--');
xlabel('x (m)','interpreter','latex')
ylabel('y (m)','interpreter','latex')
zlabel('z (m)','interpreter','latex')
legend('$\mathbf{x}_1$ position','$\mathbf{x}_2$ position','payload*assis position','position references','interpreter','latex','orientation','horizontal','location','northoutside');
