function [] = rPlotPosition(idAtraso, tmax)
...
for j = (1:4)
    ...
    name_fig = sprintf('C:%cUsers%cleo_j%cDropbox%cDropbox%cAuRoRA 2018%cTime-delayed Communication%cFigs%cfigPos Atraso_%d_Amostras', '\', '\', '\', '\', '\', '\', '\', '\', idAtraso(j));
