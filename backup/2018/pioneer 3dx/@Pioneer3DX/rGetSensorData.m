...
if p3dx.pFlag.Connected    
    ...
    p3dx.pPos.Xs([1 2 3]) = p3dx.pPos.Xc([1 2 3]) + ...
        [p3dx.pPar.a*cos(p3dx.pPos.Xc(6)); p3dx.pPar.a*sin(p3dx.pPos.Xc(6)); 0];
    p3dx.pPos.Xs([4 5 6]) = p3dx.pPos.Xc([4 5 6]); 
    p3dx.pPos.Xs(7:8) = K2 * p3dx.pSC.U;
    p3dx.pPos.Xs(12) = p3dx.pSC.U(2);
    ...
    % Simulation    
    p3dx.pPos.Xs = p3dx.pPos.X;
    
    % Robot center position
    p3dx.pPos.Xc([1 2 6]) = p3dx.pPos.X([1 2 6]) - [p3dx.pPar.a*cos(p3dx.pPos.Xs(6)); p3dx.pPar.a*sin(p3dx.pPos.Xs(6)); 0];   
end